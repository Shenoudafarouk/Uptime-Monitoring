...
describe('Monitor', function () {
  ...
  it('#1 should pass', function (done) {
    ...
    let ping = new Monitor({
      website: 'https://www.google.com/must-pass',
      interval: 1,
      config: {
    ...
    ping.on('up', function (res, state) {
      ...
      expect(state.website).to.equal('https://www.google.com/must-pass');
  ...
  it('#2 should pass', function (done) {
    ...
    let ping = new Monitor({
      website: 'https://www.google.com/must-pass-1',
      interval: 300,
      config: {
    ...
    ping.on('up', function (res, state) {
      ...
      expect(state.created_at).to.be.gt(0);
      expect(state.isUp).to.be.true;
      expect(state.website).to.equal('https://www.google.com/must-pass-1');
      expect(state.address).to.be.a('null');
      expect(state.port).to.be.a('null');
  ...
  it('state should override monitor options', function (done) {
    ...
    let pinger = new Monitor({
      website: 'https://www.google.com/must-fail',
      interval: 0.2
    }, {
      website: 'https://www.google.com/must-pass-2',
      interval: 0.1
    });
    ...
    pinger.on('up', function (res, state) {
      ...
      expect(state.created_at).to.be.gt(0);
      expect(state.isUp).to.be.true;
      expect(state.website).to.equal('https://www.google.com/must-pass-2');
      expect(state.address).to.be.a('null');
      expect(state.port).to.be.a('null');
  ...
  it('#4 should fail', function (done) {
    ...
    ping.on('down', function (res, state) {
      ...
      expect(state.website).to.equal('https://www.google.com/must-fail');
      expect(state.address).to.be.a('null');
      expect(state.interval).to.equal(0.1);
      expect(state.totalRequests).to.equal(1);
  ...
  it('#5 should handle the stop event', function (done) {
    ...
    let ping = new Monitor({
      website: 'https://www.google.com/must-pass-3',
      interval: 0.1
    });
  ...
  it('#7 should test redirect', function (done) {
    try {
      let pingRedirect = new Monitor({
        website: 'https://www.google.com/test-redirect',
        interval: 0.1,
        expect: {
          statusCode: 301
        }
      ...
      pingRedirect.on('up', function (res, state) {
        ...
        expect(state.created_at).to.be.gt(0);
        expect(state.isUp).to.be.true;
        expect(state.website).to.equal('https://www.google.com/test-redirect');
        expect(state.address).to.be.a('null');
        expect(state.port).to.be.a('null');
        expect(state.interval).to.equal(0.1);
        expect(state.totalRequests).to.equal(1);
  ...
  it('#8 should test httpOptions', function (done) {
    try {
      let pingHttp = new Monitor({
        website: 'https://www.google.com/test-http-options',
        interval: 500,
  ...
  it('#10 should timeout request', function (done) {
    try {
      let pingHttp = new Monitor({
        website: 'https://www.google.com/timeout',
        interval:1,
        config: {
          intervalUnits: 'seconds'
        },
  ...
  it('#11 should load broken ssl', function (done) {
    try {
      let pingHttp = new Monitor({
